...
tv = bill("livingroom tv", 8, 81.00)
wmbeds = bill("kidsbeds", 14, 68.00)
...
amzncc = debt("amazon card", 3, 29.00, 528.87, 26.24)
hmdpt = debt("home depot", 2, 29.00, 170.45, 26.99)
newegg = debt("newegg card", 28, 30.00, 434.26, 29.99)
target = debt("target card", 5, 29.00, 491.00, 23.15)
...
snfvg.payoff_time(500)
snfvb.payoff_time(0)
lnfmc.payoff_time(0)
lnfvb.payoff_time(0)
spypl.payoff_time(0)
lpypl.payoff_time(0)
amzncc.payoff_time(0)
hmdpt.payoff_time(0)
newegg.payoff_time(0)
target.payoff_time(0)
